...
import {tex, trans, transChoice, tcex} from './../../utils/translate'
  ...
  <tr className="selected-rows active">
    ...
    <td className="table-actions text-right">
      ...
      >
        ...
        <span className="sr-only">{tex('share')}</span>
      </button>
      <button
        role="button"
...
const QuestionRow = props =>
  <TableRow className={props.isSelected ? 'selected' : null}>
    ...
    <TableCell>
     <small className="text-muted"> {props.question.type}</small>
    </TableCell>
    <TableCell>
      <span onClick={() => False}>{props.question.title || props.question.content}</span>
    </TableCell>
    <TableCell>
