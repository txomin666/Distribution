      ...
      <BaseModal {...this.props} className="search-modal">
        <Modal.Body>
          ...
          <a role="button" onClick={() => this.setState({moreFilters: !this.state.moreFilters})}>
            ...
            {trans(this.state.moreFilters ? 'filters_less' : 'filters_more')}
          </a>
        </Modal.Body>
