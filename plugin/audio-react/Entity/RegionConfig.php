 ...
 * RegionConfig.
 *
 * @ORM\Table(name="innova_audio_react_media_resource_region_config")
 * @ORM\Entity
 */
class RegionConfig implements \JsonSerializable
{
    ...
    /**
     * @var region
     * @ORM\OneToOne(targetEntity="Innova\AudioReactBundle\Entity\Region", inversedBy="regionConfig")
     * @ORM\JoinColumn(nullable=false)
     */
    private $region;

    /**
     * @ORM\OneToMany(targetEntity="Innova\AudioReactBundle\Entity\HelpText", cascade={"remove", "persist"}, mappedBy="regionConfig")
     */
    private $helpTexts;

    /**
     * @ORM\OneToMany(targetEntity="Innova\AudioReactBundle\Entity\HelpLink", cascade={"remove", "persist"}, mappedBy="regionConfig")
     */
    private $helpLinks;
