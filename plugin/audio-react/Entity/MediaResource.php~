 ...
 *
 * @ORM\Table(name="innova_audio_react_media_resource")
 * @ORM\Entity
 */
class MediaResource extends AbstractResource implements \JsonSerializable
{
     ...
     * @var medias
     *
     * @ORM\OneToMany(targetEntity="Innova\AudioReactBundle\Entity\Media", cascade={"remove", "persist"}, mappedBy="mediaResource")
     */
    protected $medias;

    /**
     * @ORM\OneToMany(targetEntity="Innova\AudioReactBundle\Entity\Region", cascade={"remove", "persist"}, mappedBy="mediaResource")
     */
    protected $regions;

    /**
     * @ORM\OneToOne(targetEntity="Innova\AudioReactBundle\Entity\Options", cascade={"remove", "persist"})
     */
    protected $options;
