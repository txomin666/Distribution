 ...
 * Region.
 *
 * @ORM\Table(name="innova_audio_react_media_resource_region")
 * @ORM\Entity(repositoryClass="Innova\AudioReactBundle\Repository\RegionRepository")
 */
class Region implements \JsonSerializable
{
    ...
    /**
     * @var MediaResource
     * @ORM\ManyToOne(targetEntity="Innova\AudioReactBundle\Entity\MediaResource", inversedBy="regions")
     ...
     * @ORM\OneToOne(targetEntity="Innova\AudioReactBundle\Entity\RegionConfig", mappedBy="region", cascade={"persist", "remove"})
     */
