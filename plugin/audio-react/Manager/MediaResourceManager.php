...
use Innova\AudioReactBundle\Entity\Media;
...
/**
 * @DI\Service("innova_audio_react.manager.media_resource")
 */
class MediaResourceManager
{
    ...
    {
        return $this->em->getRepository('InnovaAudioReactBundle:MediaResource');
    }
     ...
     *
     * @return \Innova\AudioReactBundle\Manager\MediaResourceManager
     */
