...
use Innova\AudioReactBundle\Entity\HelpLink;
use Innova\AudioReactBundle\Entity\HelpText;
use Innova\AudioReactBundle\Entity\MediaResource;
use Innova\AudioReactBundle\Entity\Region;
use Innova\AudioReactBundle\Entity\RegionConfig;
use JMS\DiExtraBundle\Annotation as DI;

/**
 * @DI\Service("innova_audio_react.manager.media_resource_region")
 */
class RegionManager
{
    protected $em;
    ...
    {
        return $this->em->getRepository('InnovaAudioReactBundle:Region');
    }
