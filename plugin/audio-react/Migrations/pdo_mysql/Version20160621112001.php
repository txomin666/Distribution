...
namespace Innova\AudioReactBundle\Migrations\pdo_mysql;
...
class Version20160621112001 extends AbstractMigration
{
    ...
    {
        $this->addSql('
            CREATE TABLE innova_audio_react_media_resource_media (
        ...
        ');
        $this->addSql('
            CREATE TABLE innova_audio_react_media_resource_help_link (
                id INT AUTO_INCREMENT NOT NULL,
        ...
        ');
        $this->addSql('
            CREATE TABLE innova_audio_react_media_resource_options (
                id INT AUTO_INCREMENT NOT NULL,
        ...
        ');
        $this->addSql('
            CREATE TABLE innova_audio_react_media_resource (
                id INT AUTO_INCREMENT NOT NULL,
        ...
        ');
        $this->addSql('
            CREATE TABLE innova_audio_react_media_resource_region (
                id INT AUTO_INCREMENT NOT NULL,
                media_resource_id INT NOT NULL,
        ...
        ');
        $this->addSql('
            CREATE TABLE innova_audio_react_media_resource_region_config (
                id INT AUTO_INCREMENT NOT NULL,
        ...
        ');
        $this->addSql('
            CREATE TABLE innova_audio_react_media_resource_help_text (
                id INT AUTO_INCREMENT NOT NULL,
                region_config_id INT NOT NULL,
        ...
        ');
        $this->addSql('
            ALTER TABLE innova_audio_react_media_resource_region
            ADD CONSTRAINT FK_B1E36FE87E5AEFB6 FOREIGN KEY (media_resource_id)
            REFERENCES media_resource (id)
        ');
        $this->addSql('
            ALTER TABLE innova_audio_react_media_resource_region_config
            ADD CONSTRAINT FK_2EEE09F098260155 FOREIGN KEY (region_id)
            REFERENCES media_resource_region (id)
        ');
        $this->addSql('
            ALTER TABLE innova_audio_react_media_resource_help_text
    ...
    public function down(Schema $schema)
    {
        ...
        ');
        $this->addSql('
            DROP TABLE innova_audio_react_media_resource_media
        ');
        $this->addSql('
            DROP TABLE innova_audio_react_media_resource_help_link
        ');
        $this->addSql('
            DROP TABLE innova_audio_react_media_resource_options
        ');
        $this->addSql('
            DROP TABLE innova_audio_react_media_resource
        ');
        $this->addSql('
            DROP TABLE innova_audio_react_media_resource_region
        ');
        $this->addSql('
            DROP TABLE innova_audio_react_media_resource_region_config
        ');
        $this->addSql('
            DROP TABLE innova_audio_react_media_resource_help_text
        ');
    }
}
