...
const Badge = connect(
  state => ({
    ...
    user: formSelect.data(formSelect.form(state, 'badges.current'))
  }),
  dispatch => ({
    updateProp(propName, propValue) {
      dispatch(formActions.updateProp('badges.current', propName, propValue))
    },
    pickGroups(userId) {
