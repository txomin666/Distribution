...
namespace Claroline\AuthenticationBundle\Entity\ExternalSynchronization;
 ...
 * })
 * @ORM\Entity(repositoryClass="Claroline\AuthenticationBundle\Repository\ExternalSynchronization\ExternalUserRepository")
 */
class ExternalUser
{
    /**
